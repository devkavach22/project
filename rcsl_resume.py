...
Extract all information from the resume text provided by the user.
...
experience: [{{
  ...
  is_current_employment (bool), employment_type, salary,
  responsibilities (array of strings), technologies (array)
}}],

education: [{{
  education_level, institution, degree, field_of_study,
  course_type, start_date, end_date, passing_year, gpa
}}],

skills: {{ hard_skills: [], soft_skills: [] }},

projects:       [{{ title, description, url, technologies, start_date, end_date }}],
certifications: [{{ name, issuer, completion_id, url, start_month, start_year,
                    end_month, end_year, does_not_expire, date_obtained }}],
